...
file_out ="planetassb" # Nombre del fichero de salida (sin extensión)
...
# planet_radius = 1 
planet_radius = [0.0465, 0.00016, 0.00042, 0.00043, 0.00022, 0.00467, 0.00389, 0.00158, 0.0015, 0.00008]   # Todos los radios * 10
# planet_radius = [0.0465, 0.016, 0.042, 0.043, 0.022]    # radios interiores *1000, sol*10
# planet_radius = [0.465, 0.467, 0.389, 0.158, 0.15, 0.008] # radios exteriores *1000, sol*100

# Radios de los planetas para los sistemas geocéntricos

# planet_radius = [0.0465, 0.00043, 0.00016] # Sistema geocéntrico mercurio * 10
# planet_radius = [0.0465, 0.00043, 0.00042] # Sistema geocéntrico venus * 10
# planet_radius = [0.465, 0.0043, 0.0022] # Sistema geocéntrico marte * 100
# planet_radius = [0.465, 0.0043, 0.0467] # Sistema geocéntrico júpiter * 100
# planet_radius = [0.465, 0.0043, 0.0389] # Sistema geocéntrico saturno * 100
# planet_radius = [0.465, 0.0043, 0.0158] # Sistema geocéntrico urano *100
# planet_radius = [0.465, 0.0043, 0.0150] # Sistema geocéntrico neptuno * 100
# planet_radius = [0.465, 0.0043, 0.0008] # Sistema geocéntrico plutón * 100
